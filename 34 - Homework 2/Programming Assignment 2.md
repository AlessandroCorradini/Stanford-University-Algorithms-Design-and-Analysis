...
In this programming problem and the next you'll code up the clustering algorithm from lecture for computing a max-spacing -clustering.
...
There is one edge (i, j) for each choice of 1 <= u < j <= n, where n is the number of nodes.
